        ...
        <template slot="bodyCreate">
            <form class="col-12 px-0 create-form">
                ...
                <div class="mt-4 row align-items-center">
                    ...
                    <datepicker placeholder="User Birthdate" type="date" name="birthdat" class="col-12 text-p px-0" v-model="user.birthdate" :format="'M-d-yyyy'" :input-class="'small border border-bottom border-left-0 border-right-0 border-top-0 form-control rounded-0 bg-transparent'"></datepicker>
                </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                errors: {email: null, name: null, role: null},
            }
        },
        watch: {
            showModals(value) {
