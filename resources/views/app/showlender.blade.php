        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-sm-6 my-3">
                    ...
                    <h4 class="float-left mr-5">First Global</h4>
                    ...
                    <nav>
                        <ol class="breadcrumb small p-0 mt-2">
                            ...
                            <li class="breadcrumb-item">
                                <a href="#" class="text-primary">Lenders list</a>
                            </li>
                            <li class="breadcrumb-item active font-weight-light">First Global</li>
                        </ol>
                    </nav>
                        ...
                        <div class="mb-4 row mx-0">
                            <div class="col-12 small border-bottom pb-3">
                                <a href="javascript:;" id="lead-collapse-closed" data-toggle="collapse" data-target=".lead-info"  class="card-link link-collapse collapsed" >
                                    <h6 class="mt-3 mb-0">
                                        <span class="ion ion-briefcase"></span>Lender ID:
                                        U145234<span class="ion ion-chevron-right text-default float-right arrow-collapse mt-1"></span>
                                    </h6>
                                </a>
                            </div>
                                    ...
                                    <div class="col pl-0 pr-3">
                                        <div class="col-12 small px-0">
                                            <h6 class="mb-2 text-primary mt-3 field">
                                                ...
                                                <input readonly id="lead-name" placeholder="Contact name" class="text-primary border-0 w-100" value="First Global">
                                            </h6>
                                        </div>
                                        <div class="col-12 small px-0">
                                            <p class="mb-2 field">
                            ...
                            <div class="lead-info col-12 collapse" >
                                ...
                                <div class="row small px-3 position-relative">
                                    <p class="border-bottom field mb-0 py-2 w-100">
                                        ...
                                        <span class="small ion ion-edit position-absolute"></span>
                                        <input id="lead-name" class="text-default border-0" value="First Global">
                                    </p>
                                </div>
                                ...
                                <div class="row px-3 small position-relative">
                                    <p class="border-bottom field mb-0 py-2 w-100">
                                        <span class="ion ion-minus text-primary"></span>
                                        <label class="font-weight-normal mb-0 small text-primary">Min Loan Size:</label>
                                        <span class="small ion ion-edit position-absolute"></span>
                                        <input id="min-loan" placeholder="Min loan size" class="text-default border-0" value="(458) 245-2145">
                                    </p>
                                </div>
                                <div class="row px-3 small position-relative">
                                    <p class="border-bottom field mb-0 py-2 w-100">
                                        <span class="ion ion-plus text-primary"></span>
                                        <label class="font-weight-normal mb-0 small text-primary">Max Loan Size:</label>
                                        <span class="small ion ion-edit position-absolute"></span>
                                        <input id="max-loan" placeholder="Max loan size" class="text-default border-0" value="(458) 245-2145">
                                    </p>
                                </div>
                                <div class="row px-3 small position-relative">
                                    <p class="border-bottom field mb-0 py-2 w-100">
                                        <span class="ion ion-minus text-primary"></span>
                                        <label class="font-weight-normal mb-0 small text-primary">Min Interest Rate:</label>
                                        <span class="small ion ion-edit position-absolute"></span>
                                        <input id="min-rate" placeholder="Min interest rate (%)" class="text-default border-0" value="1.5 %">
                                    </p>
                                </div>
                                <div class="row px-3 small position-relative">
                                    <p class="border-bottom field mb-0 py-2 w-100">
                                        <span class="ion ion-plus text-primary"></span>
                                        <label class="font-weight-normal mb-0 small text-primary">Max Interest Rate:</label>
                                        <span class="small ion ion-edit position-absolute"></span>
                                        <input id="max-rate" placeholder="Max interest rate (%)" class="text-default border-0" value="3.5 %">
                                    </p>
                                </div>
                                <div class="row px-3 small position-relative">
                                    <p class="border-bottom field mb-0 py-2 w-100">
                                        ...
                                        <span class="small ion ion-edit position-absolute"></span>
                                        <input id="min-terms" placeholder="Min Terms" class="text-default border-0" value="2 months">
                                    </p>
                                </div>
                                <div class="row px-3 small position-relative">
                                    <p class="border-bottom field mb-0 py-2 w-100">
                                        ...
                                        <span class="small ion ion-edit position-absolute"></span>
                                        <input id="max-terms" placeholder="Max Terms" class="text-default border-0" value="15 months">
                                    </p>
                                </div>
                                <div class="row px-3 small position-relative">
                                    <p class="border-bottom field mb-0 py-2 w-100">
                                        <span class="ion ion-ios-minus-outline text-primary"></span>
                                        <label class="font-weight-normal mb-0 small text-primary">Negative Days:</label>
                                        <span class="small ion ion-edit position-absolute"></span>
                                        <input id="negative-days" placeholder="Negative Days" class="text-default border-0" value="5 days">
                                    </p>
                                </div>
                                <div class="row px-3 small position-relative">
                                    <p class="border-bottom field mb-0 py-2 w-100">
                                        <span class="ion ion-ios-medical-outline text-primary"></span>
