...
class DynamicVarTest extends TestCase
{
    protected $url   = 'api/v1/dynamic-vars/';
    protected $table = 'dynamic_vars';

    /**
     * A basic test example.
     */
    public function test_list_dynamic_var()
    {
        $data     = factory(DynamicVar::class)->create();
    ...
    public function test_show_dynamic_var()
    {
        $data     = factory(DynamicVar::class)->create();
    ...
    public function test_create_dynamic_var()
    {
        $data     = factory(DynamicVar::class)->make();
    ...
    public function test_update_dynamic_var()
    {
        $old      = factory(DynamicVar::class)->create();
        $data     = factory(DynamicVar::class)->make();
    ...
    public function test_delete_dynamic_var()
    {
        $data     = factory(DynamicVar::class)->create();
